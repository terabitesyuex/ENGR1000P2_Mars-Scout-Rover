...
The current physical inventory has one RPLIDAR C1M1-R2, identified as `c1_1`.
Historical recordings may contain `c1_2`; that ID is retained only for compatibility.
...
Manual Phase 2.5 steps for the one physical unit:
...
`c1_1` is the sole baseline integration target. Simultaneous dual-C1 operation is NOT CURRENT SCOPE.
