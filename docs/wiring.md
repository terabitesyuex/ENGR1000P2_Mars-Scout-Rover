...
GPIO values are not selected. GPIO20 as ESP32 RX and GPIO21 as ESP32 TX are only candidates after the ESP32-C3 SuperMini board silkscreen and board documentation confirm availability. These values remain UNVERIFIED.
