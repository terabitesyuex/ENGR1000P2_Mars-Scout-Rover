...
- The user reports that the complete vehicle has been assembled according to the
  repository wiring plan. The 2026-07-23 evidence batch archives exterior,
  underside-sensor, MPU6050-orientation, and CAD screenshots plus supplied
  dimensions: 79 mm wheel diameter, 190 mm wheelbase, 217 mm track width, and
  C1 scan-plane height 85.8 mm above the chassis upper surface. These are
  MANUAL_EVIDENCE_VERIFIED only as supplied records. Continuity, rail voltages,
  protection, CN1-CN4 wheel tracing, motor/encoder signs, source-CAD axis
  transform, and integrated operation remain UNVERIFIED. Use
