...
def manual_status_text() -> str:
    return "\n".join(
        [
            ...
            "firmware_flash: MANUAL_ACTION_REQUIRED",
            "physical_wiring: UNVERIFIED",
            "power_integrity: UNVERIFIED",
            "voltage_levels: UNVERIFIED",
            "USART2_RPLIDAR_operation: UNVERIFIED",
            "USART3_ESP32_operation: UNVERIFIED",
            "I2C_ACKs: UNVERIFIED",
            "sensor_polarity: UNVERIFIED",
            "ultrasonic_timing: UNVERIFIED",
            "real_sensor_data: UNVERIFIED",
        ]
    ) + "\n"
