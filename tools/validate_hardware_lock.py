...
REQUIRED_TEXTS: tuple[RequiredText, ...] = (
    ...
    RequiredText("HARDWARE_LOCK.md", "RPLIDAR C1 x1", "single physical C1 inventory"),
    RequiredText("HARDWARE_LOCK.md", "HC-SR04 ultrasonic sensor x3", "three HC-SR04 inventory"),
    RequiredText(
        "HARDWARE_LOCK.md",
        "`c1_2` is synthetic compatibility coverage only",
        "c1_2 fixture-only boundary",
    ),
    ...
    RequiredText("HARDWARE_LOCK.md", "Physical C1 serial ID: UNVERIFIED", "unverified serial status"),
